  ...
  return (
    <Page title="Privacy Policy">
      <Container maxWidth={themeStretch ? false : 'xl'}>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              &quot;Our&quot; in this Agreement) refers to OpenRateBoost.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to OpenRateBoost, accessible from{' '}
              <a href="openrateboost.ai" rel="external nofollow noopener" target="_blank">
                openrateboost.ai
              </a>
            </p>
          </li>
        ...
        <ul>
          <li>By email: thebrandonmbest@gmail.com</li>
        </ul>
      </Container>
    </Page>
  );
