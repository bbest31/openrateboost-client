...
export default function PricingPlanCard({ card, index, click }) {
  const { subscription, icon, price, caption, lists, labelAction, active } = card;
  ...
  return (
    <RootStyle>
      ...
      <Button fullWidth size="large" variant="contained" disabled={active} onClick={click}>
        {labelAction}
      </Button>
    </RootStyle>
  );
